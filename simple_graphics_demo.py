...
while not done:
    ...
    # Draw on the screen a line from (105, 105) to (400, 500)
    # 5 pixels wide.
    pygame.draw.line(screen, GREEN, [105, 105], [400, 500], 5)
    ...
    # Draw on the screen several lines from (105, 115) to (400, 510)
    # 5 pixels wide using a loop
    for y_offset in range(0, 100, 10):
        pygame.draw.line(screen, RED, [105, 115 + y_offset], [400, 510 + y_offset], 5)
    ...
    font = pygame.font.Font('Calibri', 25, True, False)
